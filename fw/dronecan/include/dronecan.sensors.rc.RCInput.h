...
static inline void _dronecan_sensors_rc_RCInput_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct dronecan_sensors_rc_RCInput* msg, bool tao);
...
void _dronecan_sensors_rc_RCInput_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct dronecan_sensors_rc_RCInput* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
