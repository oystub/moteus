...
static inline void _dronecan_protocol_Stats_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct dronecan_protocol_Stats* msg, bool tao);
...
void _dronecan_protocol_Stats_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct dronecan_protocol_Stats* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
